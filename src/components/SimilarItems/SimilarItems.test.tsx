...
const renderWithRouter = (products: SimilarProduct[]) =>
  render(
    <MemoryRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
      <SimilarItems similarProducts={products} />
    </MemoryRouter>,
  )
...
describe('SimilarItems', () => {
  ...
  it('renders the title and products', () => {
    renderWithRouter(makeSimilar(3))
  ...
  it('limits to 6 similar products', () => {
    renderWithRouter(makeSimilar(10))
  ...
  it('each item links to the correct product page', () => {
    renderWithRouter(makeSimilar(2))
